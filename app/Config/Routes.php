...
$routes->get('regimes/purchase/(:num)', 'RegimeController::purchase/$1', ['filter' => 'auth']);
$routes->post('regimes/purchase/(:num)', 'RegimeController::confirmPurchase/$1', ['filter' => 'auth']);
